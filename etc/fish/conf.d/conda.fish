set -gx CONDA_EXE (cygpath "D:/AV\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "D:/AV")
set _CONDA_EXE (cygpath "D:/AV\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "D:/AV\python.exe")
